...
const { chains, provider } = configureChains(
  ...
  [
    ...
    alchemyProvider({ alchemyId: "IItFVmzc5gWClV0ba3hDDdqtppKw-9OP" }),
    publicProvider(),
  ]
);
      ...
      <RainbowKitProvider chains={chains}>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              exact
              path="/decentralized-wallet"
              element={<Sidebar page={"wallet"} />}
            />
            <Route
              exact
              path="/manage-your-tokens"
              element={<Sidebar page={"contract"} />}
            />
            <Route
              exact
              path="/tokensale"
              element={<Sidebar page={"search"} />}
            />
            <Route
              exact
              path="/sto-ico-token-sale"
              element={<Sidebar page={"sale"} />}
            />
            <Route
              exact
              path="/create-token-locker"
              element={<Sidebar page={"lock"} />}
            />
            <Route exact path="/manage" element={<Sidebar page={"manage"} />} />
            <Route
              exact
              path="/managetoken/:TOKEN"
              element={<Sidebar page={"managetoken"} />}
            />
            <Route
              exact
            ...
            <Route
              ...
              element={<Sidebar page={"saletoken"} />}
            />
            <Route
              exact
              path="/staking"
              element={<Sidebar page={"stakingpool"} />}
            />
            <Route exact path="/createstaking/:TOKEN" element={ <Sidebar page="createstaking" /> } />
            <Route
              exact
              path="/editsale/:SALE"
              element={<Sidebar page={"editsale"} />}
            />
            <Route
              exact
              path="/managesale/:SALE"
              element={<Sidebar page={"managesale"} />}
            />
            <Route
              exact
              path="/buysale/:SALE"
            ...
            <Route
              exact
              path="/token-airdrop"
              element={<Sidebar page={"distributetoken"} />}
            />
