    ...
    const [content, SetContent] = useState({
        ...
        btn2: {
            line1: {
                no: "01",
                head: "LOCKED TOKENS:",
                content: "These are the tokens held in a secure locker by users. Locked tokens are used for various purposes, such as participating in governance or unlocking premium features."
            },
            line2: {
                no: "02",
                head: "VESTING SCHEDULE: ",
                content: "The vesting schedule determines when users can unlock their locked tokens. This schedule can vary from project to project and can include cliff periods and gradual vesting over time."
            },
            line3: {
                no: "03",
                head: "EARLY WITHDRAWAL:",
                content: "Some projects may allow early withdrawal of locked tokens, but it often comes with penalties or restrictions. Check the project's terms for details."
            },
            line4: {
                no: "04",
                head: "NO WITHDRAWAL:",
                content: "In some cases, locked tokens cannot be withdrawn until a specific condition is met, such as a project milestone or a governance vote."
            }
        },
        btn3: {
            line1: {
                no: "01",
                head: "ICO TOKENS:",
                content: "These are the tokens available for purchase during the Initial Coin Offering (ICO). Users can acquire these tokens by participating in the ICO event."
            },
            line2: {
                no: "02",
                head: "ICO DETAILS: ",
                content: "The ICO details include information about token pricing, token sale duration, and any bonus structures or discounts available to early participants."
            },
            line3: {
                no: "03",
                head: "TOKEN DISTRIBUTION:",
                content: "After the ICO concludes, tokens are distributed to participants based on their contributions. This distribution process may involve smart contracts and vesting schedules."
            },
            line4: {
                no: "04",
                head: "USE CASES:",
                content: "ICO tokens can be used for various purposes within the project's ecosystem, such as accessing platform features, participating in governance, or trading on cryptocurrency exchanges."
            }
        },
        btn4: {
            line1: {
                no: "01",
                head: "AIRDROP TOKENS:",
                content: "These are free tokens distributed to users as part of an airdrop campaign. Users can receive airdrop tokens without any cost or obligation."
            },
            line2: {
                no: "02",
                head: "AIRDROP CAMPAIGN: ",
                content: "The airdrop campaign specifies the criteria and rules for eligibility. Users may need to perform specific actions or meet certain conditions to qualify for the airdrop."
            },
            line3: {
                no: "03",
                head: "DISTRIBUTION METHOD:",
                content: "Airdrop tokens are typically distributed automatically to eligible users' wallets. This process may require users to complete KYC (Know Your Customer) verification."
            },
            line4: {
                no: "04",
                head: "USE OF AIRDROP TOKENS:",
                content: "Airdrop tokens can be used for various purposes, such as trading on cryptocurrency exchanges, participating in project activities, or accessing exclusive features."
            }
        },
        btn5: {
            line1: {
                no: "01",
                head: "TOKEN LAUNCH ON DEX:",
                content: "Launch your tokens on a Decentralized Exchange (DEX) using our one-click service. This enables your project to list its tokens on a DEX quickly and efficiently."
            },
            line2: {
                no: "02",
                head: "SIMPLE PROCESS: ",
                content: "Our one-click platform simplifies the token launch process. You provide the necessary information, and we take care of the technical aspects, including smart contract creation and liquidity provision."
            },
            line3: {
                no: "03",
                head: "LIQUIDITY SUPPORT:",
                content: "We can assist in providing initial liquidity for your token on the DEX, ensuring that users can trade your tokens immediately after the launch."
            },
            line4: {
                no: "04",
                head: "TOKEN ACCESS:",
                content: "Once launched on the DEX, your tokens become accessible to a wide range of cryptocurrency enthusiasts and traders, increasing exposure and liquidity."
            }
        },
        btn6: {
            line1: {
                no: "01",
                head: "ASSET TOKENIZATION:",
                content: "Our Asset Tokenization service allows you to transform physical assets, such as real estate, art, or securities, into digital tokens on a blockchain."
            },
            line2: {
                no: "02",
                head: "DIGITAL REPRESENTATION: ",
                content: "We create digital tokens that represent ownership or shares in the underlying asset. These tokens are secure, transparent, and easily tradable on blockchain-based platforms."
            },
            line3: {
                no: "03",
                head: "FRACTIONAL OWNERSHIP:",
                content: "Asset tokenization enables fractional ownership, allowing multiple investors to own and trade fractions of high-value assets, making investment opportunities more accessible."
            },
            line4: {
                no: "04",
                head: "LIQUIDITY & ACCESS:",
                content: "Tokenized assets provide increased liquidity and accessibility, as they can be traded 24/7 on various blockchain-based marketplaces, opening up new investment possibilities."
            }
        }
    });
    const get_content = (button_action) => {
        let eleobj = document.getElementsByClassName("Product_list")[0];
        ...
        if (button_action == 1) {
          ...
          // Convert obj into an HTML string
        let htmlContent = "";
                ...
                <div className="Header">
                    ...
                    <div className='nav_block'>
                        ...
                        <li><Link to="/landing_page" />Blog</li> */}
                            <button className="menu_btn">Launch App</button>
                        </nav>
