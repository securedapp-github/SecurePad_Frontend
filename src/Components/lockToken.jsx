        ...
        return (<>
            ...
            <div style={{ fontSize: "20px", color: "white", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                <div>
                    ...
                    <div style={{ paddingTop: "10%", paddingBottom: "10%" }}>Wallet Token Balance</div>
    ...
    function Mains1() {
        return (<>
            ...
            <div style={{ paddingTop: '4%', display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                <Button onClick={() => {setModal(true);}} style={{ fontSize: "20px", backgroundColor: "#12D576", border: "1px solid #12D576", color: "black", fontWeight: "400", padding: "1% 12%" }}>Specify token lock</Button>
        ...
        >
          ...
          <Modal.Body>
            ...
            <div style={{ paddingTop: "30px" }}>In order to lock the token, you need to enter the number of tokens you want to lock and unlock date. Once you are happy with the parameters, hit the approve button, validate the action in your wallet and hit the lock button to complete the token locking path.</div>
            <div style={{ paddingTop: "20px",color:"#12D576"}}>Amount of token to be locked</div>
            ...
            <div style={{ paddingTop: "20px",color:"#12D576"}}>Unlock date</div>
            ...
            <div style={{ width: "100%", paddingTop: "15%", display: "flex", flexDirection: "row",justifyContent:"space-between" }}>
              ...
              {approveflag == 0 && 
               <Button onClick={approve}  style={{ backgroundColor: "#12D576", border: "#12D576", padding: "7px 25px", fontSize: "20px", fontWeight: "450" }} variant="">Approve</Button>
    }
    {approveflag == 1 &&  
              <Button onClick={lockToken}  style={{ backgroundColor: "#12D576", border: "#12D576", padding: "7px 25px", fontSize: "20px", fontWeight: "450" }} variant="">Lock</Button>
    }
              </div>
            </div>
          </Modal.Body>
    ...
    function Mains2() {
      ...
      >
        ...
        <Modal.Body>
            ...
            <input value={newtime} onChange={(e) => setNewtime(e.target.value)} type="datetime-local" placeholder="yyyy-mm-dd hh:mm:ss" style={{ width: "100%", height: "50px", borderRadius: "5px", border: "1px solid #949494",backgroundColor:"#f4f4f4" }} />
            <div style={{ width: "100%", paddingTop: "15%", display: "flex", flexDirection: "row",justifyContent:"space-between" }}>
