              ...
              <div style={{ paddingTop: "7%", fontSize: "20px", color: "white", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                ...
                <div>
                  ...
                  <div style={{ color: "#525252", paddingTop: "1vw" }}>
                    {tokenSymbol}</div>
                  <div onClick={() => {copyAddress(TOKEN)}} style={{ paddingTop: "1vw" }}>
                  ...
                  <div style={{ color: "#525252", paddingTop: "1vw" }}>
                    {price}</div>
                  <div onClick={() => {copyAddress(payment)}} style={{ color: "#525252", paddingTop: "1vw" }}>
                  ...
                  <div style={{ color: "#525252", paddingTop: "1vw" }}>
                    {releasemonths}</div> 
                  <div onClick={() => {copyAddress(owner)}} style={{ color: "#525252", paddingTop: "1vw" }}>
                    {formatAddress(owner)}</div>
                </div>
              </div>
              ...
              >
                ...
                <Modal.Body>
                  ...
                  <div style={{ padding: "3% 7%", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    <div>
                      <div onClick={() => { copyAddress(sale) }} style={{ color: "#2D5C8F" }}>
