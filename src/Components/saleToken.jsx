...
function SaleToken() {
  ...
  return (
    ...
    {confirmpage && (
      ...
      <div>
          <div >Token Name</div>
          <div style={{paddingTop:"1vw"}}>Token Symbol</div>
          <div style={{paddingTop:"1vw"}}>Token Address</div>
          <div style={{paddingTop:"1vw"}}>Total Token Supply</div>
          <div style={{paddingTop:"1vw"}}>Tokens on Sale</div>
          <div style={{paddingTop:"1vw"}}>Price per Token in Payment Token</div>
          <div style={{paddingTop:"1vw"}}>Payment Token</div>
          <div style={{paddingTop:"1vw"}}>Soft Cap</div>
          <div style={{paddingTop:"1vw"}}>Hard Cap</div>
          <div style={{paddingTop:"1vw"}}>Min Token Purchase</div>
          <div style={{paddingTop:"1vw"}}>Max Token Purchase</div>
          <div style={{paddingTop:"1vw"}}>Sale Start Time</div>
          <div style={{paddingTop:"1vw"}}>Sale Duration</div>
          <div style={{paddingTop:"1vw"}}>Cliff - Months Before Release</div>
          <div style={{paddingTop:"1vw"}}>Release Over Months</div>
          <div style={{paddingTop:"1vw",paddingBottom:"10%"}}>Sale Owner </div>
      </div>
      <div>
