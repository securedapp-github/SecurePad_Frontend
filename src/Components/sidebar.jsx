...
import StakingPool from "./stakingPool.jsx";
import CreateStaking from "./createStaking.jsx";
...
function Sidebar(props) {
  ...
  const handleShow = () => {
    let alp = document.getElementById("sidebar2");
    alp.style.transform = "translate(10px)";
    setExpand1(true);
    // setTimeout(()=>{
  ...
  function Main() {
    ...
    if (typeof address == "undefined") {
      ...
      if (page == "stakingpool") return <StakingPool theme={theme} />;
      if (page == "createstaking") return <CreateStaking theme={theme} />;
      if (page == "managetoken") {
  ...
  function NavIcons() {
    return (
      <>
        <Link to="/tokensale" className="rihtLink" id="sales">
          {" "}
          <div
            onClick={() => {
              setCol([
        ...
        <Link to="/staking" className="rihtLink" id="pricing">
          <div
            onClick={(e) => {
              // e.preventDefault();
              // toast("Coming Soon");
        ...
        <Link to="/contact" className="rihtLink" id="contact">
          <div
            onClick={() => {
              setCol([
                false,
  ...
  return (
    <div className="mainpage">
      ...
      >
        <Link to="/">
          <div
            style={{ paddingTop: "1.389vw" }}
            className="expanded_2"
            onClick={() => {
              setCol([
                false,
                false,
          ...
          >
            ...
            />
            <div
              className="expanded-2 expanded_3"
              style={{
                fontWeight: "700",
                fontSize: "1.5vw",
                paddingTop: "0.6vw",
        ...
        >
          <Link to="/">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[0] ? "#12D576" : "white" }}
              >
                Home
              </div>
            </div>
          ...
          <Link to="/tokensale">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[11] ? "#12D576" : "white" }}
              >
                Presales
              </div>
            </div>
          ...
          <Link to="/decentralized-wallet">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[1] ? "#12D576" : "white" }}
              >
                User Profile
              </div>
            </div>
          ...
          <Link to="/token-launchpad">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[2] ? "#12D576" : "white" }}
              >
                Create Token
              </div>
            </div>
          ...
          <Link to="/token-airdrop">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[4] ? "#12D576" : "white" }}
              >
                AirDrop Tokens
              </div>
            </div>
          ...
          <Link to="/sto-ico-token-sale">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[6] ? "#12D576" : "white" }}
              >
                Create Sale
              </div>
            </div>
          ...
          <Link to="/create-token-locker">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[7] ? "#12D576" : "white" }}
              >
                Token Locker
              </div>
            </div>
          ...
          >
            <svg
              style={{ width: "100%", marginRight: "2px", fill: "transparent" }}
              width="1.5vw"
              height="1.5vw"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div
              className="expanded-2"
              style={{ color: col[8] ? "#12D576" : "white" }}
            >
              Staking Pools
            </div>
          </div>
          ...
          >
            ...
            <div
              className="expanded-2"
              style={{ color: col[9] ? "#12D576" : "white" }}
            >
              DEX Launch
            </div>
          </div>
          <Link to="/pricing">
            ...
            >
              ...
              <div
                className="expanded-2"
                style={{ color: col[10] ? "#12D576" : "white" }}
              >
                Pricing
              </div>
            </div>
          ...
          >
            ...
            <div
              onClick={() => {
                window.open(
                  "https://securedapp.gitbook.io/securedapp-launchpad/",
                  "_blank"
                );
              }}
              className="expanded-2"
              style={{ color: col[12] ? "#12D576" : "white" }}
            >
              Docs
            </div>
          </div>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `${
            theme === "Dark"
              ? "linear-gradient(to right,black,rgb(14, 14, 61))"
              : "linear-gradient(to right,#FBFBFB,#bff2d9)"
          }`,
        }}
      >
        ...
        >
          <div className="navBrand">
            ...
            >
              <img
                id="logo_img"
                src={Icon}
                style={{ width: "53px", height: "46px", marginTop: "-8px" }}
                alt=""
              />
              <div id="comp_name">
                <div
          ...
          <div className="riht">{size ? <NavIcons /> : <div></div>}</div>
        </div>
        <Main />
      </div>
    </div>
