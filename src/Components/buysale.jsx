                ...
                <div style={{ paddingBottom: "2vw", width: "100%", marginTop: "3vw", backgroundColor: "rgba(70,70,70,0.4)", borderRadius: "3vw" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div style={{ paddingTop: "0.2vw" }}>
                            ...
                            {web !== undefined && (
                                <svg onClick={(event) => { window.open(web, "_blank"); }} xmlns="http://www.w3.org/2000/svg" width="1.3vw" height="1.3vw" style={{ fill: "#12D576", margin: "0.4vw" }} class="bi bi-globe" viewBox="0 0 16 16">
                                ...
                                <svg onClick={(event) => { window.open(twi, "_blank"); }} xmlns="http://www.w3.org/2000/svg" width="1.3vw" height="1.3vw" style={{ fill: "#12D576", margin: "0.4vw" }} class="bi bi-twitter" viewBox="0 0 16 16">
                                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                                </svg>
                            )}{git !== undefined && (
                                <svg onClick={(event) => { window.open(git, "_blank"); }} xmlns="http://www.w3.org/2000/svg" width="1.3vw" height="1.3vw" style={{ fill: "#12D576", margin: "0.4vw" }} class="bi bi-github" viewBox="0 0 16 16">
                                    <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z" />
                                </svg>
                            )} {tel !== undefined && (
                                <svg onClick={(event) => { window.open(tel, "_blank"); }} width="1.3vw" height="1.3vw" viewBox="0 0 16 16" style={{ margin: "0.4vw" }} xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg onClick={(event) => { window.open(dis, "_blank"); }} xmlns="http://www.w3.org/2000/svg" width="1.3vw" height="1.3vw" style={{ fill: "#12D576", margin: "0.4vw" }} class="bi bi-discord" viewBox="0 0 16 16">
                        ...
                        <div style={{ display: "flex", gap: "0.4vw", color: "white", paddingRight: "3vw", fontSize: "1.3vw" }}>
                            {audit != "" && (
                                <div onClick={(event) => { window.open(audit, "_blank"); }} style={{ display: "flex", gap: "0.2vw", border: "1px solid white", padding: "0.2vw 0.5vw", borderRadius: "2vw", height: "2.7vw" }}>
                            ...
                            {kyc != "" && (
                                <div onClick={(event) => { window.open(kyc, "_blank"); }} style={{ display: "flex", gap: "0.2vw", border: "1px solid white", padding: "0.2vw 0.5vw", borderRadius: "2vw", height: "2.7vw" }}>
                                    <div><svg xmlns="http://www.w3.org/2000/svg" width="1.1vw" height="1.1vw" style={{ fill: "#12D576" }} fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
                                        <path d="M5.338 1.59a61.44 61.44 0 0 0-2.837.856.481.481 0 0 0-.328.39c-.554 4.157.726 7.19 2.253 9.188a10.725 10.725 0 0 0 2.287 2.233c.346.244.652.42.893.533.12.057.218.095.293.118a.55.55 0 0 0 .101.025.615.615 0 0 0 .1-.025c.076-.023.174-.061.294-.118.24-.113.547-.29.893-.533a10.726 10.726 0 0 0 2.287-2.233c1.527-1.997 2.807-5.031 2.253-9.188a.48.48 0 0 0-.328-.39c-.651-.213-1.75-.56-2.837-.855C9.552 1.29 8.531 1.067 8 1.067c-.53 0-1.552.223-2.662.524zM5.072.56C6.157.265 7.31 0 8 0s1.843.265 2.928.56c1.11.3 2.229.655 2.887.87a1.54 1.54 0 0 1 1.044 1.262c.596 4.477-.787 7.795-2.465 9.99a11.775 11.775 0 0 1-2.517 2.453 7.159 7.159 0 0 1-1.048.625c-.28.132-.581.24-.829.24s-.548-.108-.829-.24a7.158 7.158 0 0 1-1.048-.625 11.777 11.777 0 0 1-2.517-2.453C1.928 10.487.545 7.169 1.141 2.692A1.54 1.54 0 0 1 2.185 1.43 62.456 62.456 0 0 1 5.072.56z" />
                                        <path d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
                                    </svg></div>
                            ...
                            {vetted != "" && (
                                <div onClick={(event) => { window.open(vetted, "_blank"); }} style={{ display: "flex", gap: "0.2vw", border: "1px solid white", padding: "0.2vw 0.5vw", borderRadius: "2vw", height: "2.7vw" }}>
                                    <div><svg xmlns="http://www.w3.org/2000/svg" width="1.1vw" height="1.1vw" style={{ fill: "#12D576" }} fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
                                        <path d="M5.338 1.59a61.44 61.44 0 0 0-2.837.856.481.481 0 0 0-.328.39c-.554 4.157.726 7.19 2.253 9.188a10.725 10.725 0 0 0 2.287 2.233c.346.244.652.42.893.533.12.057.218.095.293.118a.55.55 0 0 0 .101.025.615.615 0 0 0 .1-.025c.076-.023.174-.061.294-.118.24-.113.547-.29.893-.533a10.726 10.726 0 0 0 2.287-2.233c1.527-1.997 2.807-5.031 2.253-9.188a.48.48 0 0 0-.328-.39c-.651-.213-1.75-.56-2.837-.855C9.552 1.29 8.531 1.067 8 1.067c-.53 0-1.552.223-2.662.524zM5.072.56C6.157.265 7.31 0 8 0s1.843.265 2.928.56c1.11.3 2.229.655 2.887.87a1.54 1.54 0 0 1 1.044 1.262c.596 4.477-.787 7.795-2.465 9.99a11.775 11.775 0 0 1-2.517 2.453 7.159 7.159 0 0 1-1.048.625c-.28.132-.581.24-.829.24s-.548-.108-.829-.24a7.158 7.158 0 0 1-1.048-.625 11.777 11.777 0 0 1-2.517-2.453C1.928 10.487.545 7.169 1.141 2.692A1.54 1.54 0 0 1 2.185 1.43 62.456 62.456 0 0 1 5.072.56z" />
                                        <path d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
                                    </svg></div>
