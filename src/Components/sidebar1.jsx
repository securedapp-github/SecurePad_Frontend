...
function Arrow(){
    ...
    return (
        ...
        <svg  style={{position:'relative'}} id="arrow1" width="2.08vw" height="2.08vw" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle className='arrw1' cx="18" cy="18" r="18" fill="#12D576"/>
        <path  d="M20 24L14 18L20 12" stroke="#1C1E22" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
...
export function Side1({theme}){
    ...
    return (
        <div className="sidebar" id='sidebar1'  style={{backgroundColor:`${theme==='Dark' ? '#101010':'whitesmoke'}`}}>
            <Arrow/>
            <Link to='/'><div style={{paddingTop:'1.389vw'}} className='expanded_2'>
            <svg style={{width:'100%',margin:'0 auto'}} width="3.2vw" height="3.2vw" viewBox="0 0 56 55" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <rect x="0.5" width="3.2vw" height="3.2vw" fill="url(#pattern0)"/>
            <defs>
            ...
            <div className='expanded-1' style={{fontWeight:'700',fontSize:'1.5vw',paddingTop:'0.6vw'}}>SecureDApp</div>
            </div>
            </Link>
            <div style={{paddingTop:'1.62vw',display:'flex',flexDirection:'column'}}>
                <Link to='/'>
                <div className='expanded'>
                <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="24px/icon/home">
                <path id="Vector" d="M12 2L3 9V20C3 20.5304 3.21071 21.0391 3.58579 21.4142C3.96086 21.7893 4.46957 22 5 22H19C19.5304 22 20.0391 21.7893 20.4142 21.4142C20.7893 21.0391 21 20.5304 21 20V9L12 2Z" stroke="#F2F2F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path id="Vector_2" d="M9 22V12H15V22" stroke="#F2F2F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                </svg>
                <div className='expanded-1'>Home</div>
                </div>
                </Link>
                <Link to='/wallet'>
                <div className='expanded'>
                ...
                <div className='expanded-1'>User Profile</div>
                </div>
                </Link>
                <Link to='/token'>
                <div className='expanded'>
                ...
                <div className='expanded-1'>Create Token</div>
                </div>
                </Link>
                <Link to='/manage'>
                <div className='expanded'>
                ...
                <div className='expanded-1'>Manage Tokens</div>
                </div>
                </Link>
                <Link to='/contract'>
                <div className='expanded'>
                ...
                <div className='expanded-1'>AirDrop Tokens</div>
                </div> 
                </Link>
                <div className='expanded'>
                <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='expanded-1'>Create STO/ICO</div>
                </div>
                <Link to='/sale'>
                <div className='expanded'>
                <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='expanded-1'>Token Sale</div>
                </div>
                </Link>
                <Link to='/lock'>
                <div className='expanded'>
                ...
                <div className='expanded-1'>Token Locker</div>
                </div>
                </Link>
                <div className='expanded'>
                <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='expanded-1'>Staking Pools</div>
                </div>
                <div className='expanded'>
                <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='expanded-1'>DEX Launch</div>
                </div>
            </div>
            <div className='expanded' style={{marginTop:'4vw'}}>
            <svg style={{width:'100%',margin:'0 auto'}} width="1.5vw" height="1.5vw" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="paperclip">
            ...
            <div className='expanded-1'>Docs</div>
            </div>
        </div>
    )
}