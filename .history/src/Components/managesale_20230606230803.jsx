      ...
      <div className="saleFirstRow" style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ paddingLeft: "0px", width: "75%" }}>
          ...
          <div style={{ paddingTop: "1vw", fontSize: "20px", color: "white", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
            <div style={{ backgroundColor: 'white', padding: '0',  marginTop: '10px', marginRight: '20px' }}>
  <style>
    {`
      .row {
        color: black;
    ...
    `}
              ...
              <div style={{ color: 'black' }}>Token name</div>
              <div style={{ paddingTop: "1vw",color: 'black' }}>Symbol</div>
              <div style={{ paddingTop: "1vw", color: 'black'  }}>Token address</div>
              <div style={{ paddingTop: "1vw" ,color: 'black' }}>Token sale link</div>
              <div style={{ paddingTop: "1vw", color: 'black' }}>Total Token Supply</div>
              <div style={{ paddingTop: "1vw", color: 'black'  }}>Tokens currently on sale</div>
              <div style={{ paddingTop: "1vw", paddingBottom: "10%", color: 'black'  }}>Payment token</div>
            </div>
            <div>
