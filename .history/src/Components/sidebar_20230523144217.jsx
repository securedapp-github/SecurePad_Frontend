...
function sidebar(props) {
  ...
  return (
        ...
        <div className="sidebar">
          <Link to="/"> <div > <FontAwesomeIcon icon={faCoffee}  style={{color:"#464646"}} size="2x"/></div></Link> 
           <Link to="/token"> <div > <FontAwesomeIcon icon={faCoffee} style={{color:"#464646"}} size="2x"/></div></Link> 
            ...
            <Link to="/search"><div > <FontAwesomeIcon icon={faCoffee} style={{color:"#464646"}} size="2x",padding="2px"/></div></Link>
    ...
    <div  style={{position:"fixed",left:"10%"}}><div><span  style={{color:"#12D576"}}>Token Tool</span><span> by SecureDApp</span></div></div>   
