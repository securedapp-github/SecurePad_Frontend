    ...
    <div style={{ padding: "2%", margin: "0 10vw 0 20vw" }}>
      <div className="saleFirstRow" style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ paddingLeft: "0px", width: "75%" }}>
          ...
          <div style={{ paddingTop: "1vw", fontSize: "20px", color: "white", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <div style={{ paddingTop: "1vw", fontSize: "20px", display: "flex-start", flexDirection: "column", justifyContent: "space-between" }}>
