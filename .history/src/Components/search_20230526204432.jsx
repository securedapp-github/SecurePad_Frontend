    ...
    <div className="container"> 
      ...
      <div className="filter" style={{ marginLeft: '1100px',marginTop: '-60px'}}>
        ...
        >
          ...
          <option value="Card 1" style={{ color: 'blue' }}>MEME ELON DOGE FLOKI</option>
          <option value="Card 2" style={{ color: 'blue' }}>MEME ELON DOGE FLOKI</option>
          <option value="Card 3" style={{ color: 'blue' }}>MEME ELON DOGE FLOKI</option>
