...
<div className="filter">
        ...
        >
          ...
          <option value="Card 3">Card 2</option>
          <option value="Card 4">Card 2</option>
          <option value="Card 5">Card 2</option>
          <option value="Card 6">Card 2</option>
          <option value="Card 7">Card 2</option>
          <option value="Card 8">Card 2</option>
          <option value="Card 9">Card 2</option>
        </select>
        </div>
