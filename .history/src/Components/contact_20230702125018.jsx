  ...
  return (
    ...
    alignItems: 'center',
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '42vh' }}>
        ...
        <h1 className="head contact" style={{ color: `${theme === 'Dark' ? 'white' : 'black'}`,background: 'transparent', padding: '10px 10px', borderRadius: '16px', border: `2px solid ${theme === 'Dark' ? 'lightgreen' : 'green'}` }}>Contact Us</h1>
