...
function Contact(props) {
  ...
  return (
    <div  style={{ backgroundImage: `${theme === 'Dark' ? 'linear-gradient(to right, black, rgb(1, 1, 61))' : 'linear-gradient(to right, #FBFBFB, #bff2d9)'}`,  backgroundSize: 'cover', backgroundPosition: 'center',
