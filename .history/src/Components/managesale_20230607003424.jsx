  ...
  <style>
    ...
    `}
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <Button onClick={() => { setModal(true) }} style={{ backgroundColor: "#12D576", border: "#12D576", marginTop: "10vw", padding: "7px 25px", fontSize: "20px", fontWeight: "450" }} variant="">+ Add addresses</Button></div>
          </div>
          <div style={{ color: '#12D576', fontSize: "24px", fontWeight: "550", paddingTop: "7vw" }}>Withdrawls</div>

          <div style={{ backgroundColor: 'white', padding: '1vw', paddingTop: "20px" }}>
          <div style={{ color: "blacl", marginTop: "2vw", }}>Sale Token Balance: {amount}</div>
          ...
          <Button disabled={true} style={{ backgroundColor: "#12D576", border: "#12D576", marginTop: "0.1vw", padding: "7px 25px", fontSize: "20px", fontWeight: "450" }} variant="">Withdraw all funds</Button></div>
          <Modal
            {...{
              show: modal,
