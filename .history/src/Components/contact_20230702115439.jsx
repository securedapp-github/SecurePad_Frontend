...
function Contact(props) {
  ...
  return (
    <div style={{ 
      backgroundImage: `${theme === 'Dark' ? 'linear-gradient(to right, black, rgb(1, 14, 61))' : 'linear-gradient(to right, #FBFBFB, #bff2d9)'}`,
      padding: '3vw',
      height: '100vh', // Increase the height
      width: '100vw', // Increase the width
      display: 'flex',
      ...
      <div style={{
        ...
        padding: '2vw',
        borderRadius: '10px',
        maxWidth: '800px', // Limit the maximum width if needed
      }}>
        ...
        <p style={{
          textAlign: 'left',
          marginBottom: '1.5vw',
          color: `${theme === 'Dark' ? 'white' : 'rgba(255, 255, 255, 0.8)'}`,
        }}>
          Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
