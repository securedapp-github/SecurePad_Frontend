    ...
    <div style={{ padding: "2%", margin: "0 10vw 0 20vw" }}>
      <div className="saleFirstRow" style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ paddingLeft: "20px", width: "75%" }}>
          ...
          <div style={{ color: '#12D576', fontSize: "24px", fontWeight: "550", paddingTop: "3vw", paddingRight: "3vw" }}>Token sale information</div>
          <div style={{ paddingTop: "1vw", fontSize: "20px", color: "white", display: "flex", flexDirection: "row", j0ustifyContent: "space-between" }}>
            <div>
              <div >Token name</div>
              <div style={{ paddingTop: "1vw" }}>Symbol</div>
              <div style={{ paddingTop: "1vw" }}>Token address</div>
              <div style={{ paddingTop: "1vw" }}>Token sale link</div>
