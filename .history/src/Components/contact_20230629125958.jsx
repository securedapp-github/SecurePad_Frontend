...
import { faEnvelope,faLink,faTwitter } from '@fortawesome/free-solid-svg-icons';
    ...
    <div style={{ backgroundImage: `${theme === 'Dark' ? 'linear-gradient(to right, black, rgb(1, 14, 61))' : 'linear-gradient(to right, #FBFBFB, #bff2d9)'}`, padding: '1vw 33vw' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '42vh' }}>
        <div style={{ marginTop: '2vw', textAlign: 'center', backgroundColor: `${theme === 'Dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)'}`, padding: '2vw', borderRadius: '10px' }}>
          ...
          <p style={{ textAlign: 'left', marginBottom: '1.5vw', color: `${theme === 'Dark' ? 'white' : 'rgba(255, 255, 255, 0.8)'}` }}>
            Twitter:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <FontAwesomeIcon icon={faTwitter} style={{ color: 'skyblue', marginRight: '0.9vw' }} />
             <a href="https://twitter.com/your-twitter">your-twitter</a>
          </p>
          ...
          <p style={{ textAlign: 'left', marginBottom: '1.5vw', color: `${theme === 'Dark' ? 'white' : 'rgba(255, 255, 255, 0.8)'}` }}>
            ...
            <a href="https://t.me/your-telegram">your-telegram</a>
          </p>
          <hr style={{ borderTop: '2px solid #f2f2f2', margin: '1.5vw 1vw', width: '100%', marginLeft: '1%' }} />
          <p style={{ textAlign: 'left', marginBottom: '1.5vw', color: `${theme === 'Dark' ? 'white' : 'rgba(255, 255, 255, 0.8)'}` }}>
            Documentation: &nbsp; 
