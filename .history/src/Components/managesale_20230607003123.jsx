  ...
  <style>
    ...
    `}
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <Button onClick={() => { setModal(true) }} style={{ backgroundColor: "#12D576", border: "#12D576", marginTop: "2vw", padding: "7px 25px", fontSize: "20px", fontWeight: "450" }} variant="">+ Add addresses</Button></div>
          </div>
